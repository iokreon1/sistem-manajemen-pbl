...
INSERT INTO `menus` (`id`, `nama_menu`, `url`, `icon`, `id_html`, `parent_id`, `urutan`) VALUES ('17', 'Manajemen Pengguna', '#', 'fas fa-users-cog', '', '0', '1');
...
INSERT INTO `role_has_menus` (`id`, `menu_id`, `role_id`) VALUES ('62', '17', '1');
